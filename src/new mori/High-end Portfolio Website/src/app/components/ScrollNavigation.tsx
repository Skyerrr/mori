    ...
    <>
      ...
      >
        ...
        <div className="hidden md:flex flex-row gap-12 items-start" style={{ fontFamily: 'Inter, sans-serif' }}>
          <a href="#work" className="hover:text-white transition-colors duration-300 text-sm tracking-wide" style={{ color: '#999' }}>
            <span className="sr-only">Navigate to </span>01 — Work
          </a>
          <a href="#about" className="hover:text-white transition-colors duration-300 text-sm tracking-wide" style={{ color: '#999' }}>
            <span className="sr-only">Navigate to </span>02 — About
          </a>
          <a href="#contact" className="hover:text-white transition-colors duration-300 text-sm tracking-wide" style={{ color: '#999' }}>
            <span className="sr-only">Navigate to </span>03 — Contact
          </a>
          <a href="#resume" className="hover:text-white transition-colors duration-300 text-sm tracking-wide" style={{ color: '#999' }}>
