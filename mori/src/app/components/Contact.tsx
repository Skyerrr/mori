      ...
      <div className="max-w-[1440px] mx-auto w-full">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12">
          ...
          <div className="md:col-span-11">
            {/* Title */}
            <h2
              className="mb-8 md:mb-12 font-[Recoleta]"
              style={{
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  <Download size={12} style={{ strokeWidth: 0.5 }} aria-hidden="true" />
                  <span>RESUME</span>
                </a>
                ...
                >
                  <Linkedin size={12} style={{ strokeWidth: 0.5 }} aria-hidden="true" />
                  <span>LINKEDIN</span>
                </a>
              </motion.div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-6 items-center">
                    <a
                      href="/resume.pdf"
                      download
                      className="text-[#666] hover:text-white transition-colors duration-300 flex items-center gap-2 px-4 py-2 border-2 border-[#464646] hover:border-gray-400 rounded-[48px]"
                      style={{
                        fontFamily: 'Inter, sans-serif',
                        fontSize: '9.6px',
                        letterSpacing: '0.768px'
