        ...
        <div className="max-w-[1440px] mx-auto h-full flex flex-col justify-center md:justify-center">
          ...
          <div className="relative">
            ...
            >
              ...
              >
                <span style={{ fontStyle: 'normal' }}>Hey I'm</span>
                <br />
              ...
              >
                {currentNode.buttons.map((button, index) => (
                  <motion.button
                    ...
                    className="conversation-button px-5 md:px-7 py-3 md:py-4 border-2 border-[#464646] hover:border-gray-400 hover:text-white transition-all duration-300 bg-transparent disabled:opacity-50 disabled:cursor-not-allowed rounded-[48px]"
                    style={{
                      fontFamily: 'Inter, sans-serif',
